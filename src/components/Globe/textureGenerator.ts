...
export function generateEarthTextures(): {
  ...
  drawLandmass([
    ...
    [45, -10], [55, -5], [60, 10], [65, 20], [70, 30]
  ], '#3f5e42', '#8c7643', '#49a4b8', true);

  // Africa (Complete continent outline including DRC, Central Africa, Horn, and Cape)
  drawLandmass([
    [37, 10], [36, -5], [30, -10], [21, -17], [15, -17], [10, -14], [5, -4],
    [4, 8], [2, 10], [-5, 12], [-12, 13], [-18, 12], [-28, 16], [-34, 18],
    [-35, 20], [-34, 26], [-28, 32], [-20, 35], [-12, 40], [-4, 39], [0, 42],
    [12, 51], [15, 42], [22, 37], [30, 32], [32, 31], [37, 10]
  ], '#786842', '#ad8758', '#4fa9bc', true);

  // Central Africa Lush Rain Forest Biome (Congo Basin & DRC)
  drawLandmass([
    [5, 15], [4, 28], [2, 31], [-4, 30], [-10, 28], [-12, 22], [-8, 18], [-5, 12],
    [0, 10], [4, 12], [5, 15]
  ], '#265431', '#34663e', '#4fa9bc', false);
